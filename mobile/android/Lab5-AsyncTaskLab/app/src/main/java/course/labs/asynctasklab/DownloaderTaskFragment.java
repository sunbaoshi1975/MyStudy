...
public class DownloaderTaskFragment extends Fragment {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		Integer[] friendResourceIDs = (Integer[])resourceIDS.toArray(new Integer[0]);

		// TODO: Start the DownloaderTask
		downloaderTask.execute(friendResourceIDs);
	}
	...
	public class DownloaderTask extends AsyncTask<Integer, Void, String[]> {
		...
		@Override
		protected String[] doInBackground(Integer... friendResourceIDs) {
			String[] feeds = downloadTweets(friendResourceIDs);
