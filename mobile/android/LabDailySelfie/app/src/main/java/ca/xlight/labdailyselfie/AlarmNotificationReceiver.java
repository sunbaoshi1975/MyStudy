...
public class AlarmNotificationReceiver extends BroadcastReceiver {
    ...
    private final CharSequence tickerText = "Are You Taking a Selfie again!";
    private final CharSequence contentTitle = "A Kind Reminder";
    private final CharSequence contentText = "Get back to Take a Selfie!!";
    ...
    public void onReceive(Context context, Intent intent) {
        ...
        mContentIntent = PendingIntent.getActivity(context, 0,
                mNotificationIntent, Intent.FLAG_ACTIVITY_NEW_TASK);        // Intent.FLAG_ACTIVITY_NEW_TASK
