...
public class TopAirports extends Configured implements Tool {
    ...
    public int run(String[] args) throws Exception {
        ...
        Job jobA = Job.getInstance(conf, "Flight Count");
        jobA.setOutputKeyClass(Text.class);
        jobA.setOutputValueClass(IntWritable.class);

        jobA.setMapperClass(FlightCountMap.class);
        jobA.setReducerClass(FlightCountReduce.class);
...
// <<< Don't Change
    ...
    public static class FlightCountMap extends Mapper<Object, Text, Text, IntWritable> {
        String delimiters = ",";
    ...
    public static class FlightCountReduce extends Reducer<Text, IntWritable, Text, IntWritable> {
        @Override
    ...
    public static class TopAirportsMap extends Mapper<Text, Text, NullWritable, TextArrayWritable> {
        ...
        public void map(Text key, Text value, Context context) throws IOException, InterruptedException {
            ...
            if (countToTitleMap.size() > this.N  && this.N > 0) {
