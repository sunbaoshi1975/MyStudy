...
// >>> Don't Change
public class TopCarrierConnection extends Configured implements Tool {

    private static Logger theLogger = Logger.getLogger(TopCarrierConnection.class);

    public static void main(String[] args) throws Exception {
        // Make sure there are exactly 2 parameters
        if (args.length < 2) {
            theLogger.warn("TopCarrierConnection <input-dir> <output-dir>");
            throw new IllegalArgumentException("TopCarrierConnection <input-dir> <output-dir>");
        }

        int res = ToolRunner.run(new Configuration(), new TopCarrierConnection(), args);
    ...
    public int run(String[] args) throws Exception {
        ...
        jobA.setJarByClass(TopCarrierConnection.class);
        ...
        jobB.setMapperClass(TopCarrierConnectionMap.class);
        jobB.setReducerClass(TopCarrierConnectionReduce.class);
        ...
        jobB.setJarByClass(TopCarrierConnection.class);
...
// <<< Don't Change
    ...
    public static class DelayCountMap extends Mapper<Object, Text, Text, Text> {
        ...
        public void map(Object key, Text value, Context context) throws IOException, InterruptedException {
            ...
            // 2: Carrier; 4: Origin; 5:Dest; 11:ArrDelay; 12: Cancelled (0 - based)
    ...
    public static class TopCarrierConnectionMap extends Mapper<Text, Text, WritableIntPair, Text> {
        Integer N;
    ...
    public static class TopCarrierConnectionReduce extends Reducer<WritableIntPair, Text, Text, Text> {
        Integer N;
        // TODO
        @Override
        protected void setup(Context context) throws IOException,InterruptedException {
